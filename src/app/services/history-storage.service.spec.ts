...
describe('HistoryStorageService', () => {
  ...
  it('getUserHistories', () => {
    ...
    const mockHistories = testService.getHistoriesByUserId(mockUser._id);
  ...
  it('getGroupHistories', () => {
    ...
    const mockHistories = testService.getHistoriesByGroupId(mockGroup._id);
  ...
  it('createHistory', () => {
    const mockHistory = testService.getHistoriesByUserId(testService.getUserByMail('user1@user.com')._id)[0];
